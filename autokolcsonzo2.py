...
kolcsonzo.autok_hozzaadasa(Teherauto("AVG-456", "Renault Boxer", 15000, 1200))
kolcsonzo.autok_hozzaadasa(Szemelyauto("DEY-789", "OPEL Astra", 11000, 5))

# Berlesek hozzaadasa
kolcsonzo.auto_berlese("RYM-123", date(2025, 4, 13))
kolcsonzo.auto_berlese("AVG-456", date(2025, 4, 13))
kolcsonzo.auto_berlese("DEY-789", date(2025, 4, 14))
